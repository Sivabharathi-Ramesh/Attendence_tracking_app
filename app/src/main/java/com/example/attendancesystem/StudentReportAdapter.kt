...
class StudentReportAdapter(
    private val subjects: List<StudentReportSubject>,
    private val onClick: (StudentReportSubject) -> Unit
) : RecyclerView.Adapter<StudentReportAdapter.SubjectViewHolder>() {

    private lateinit var context: Context // Store context for accessing color resources

    /**
     * The ViewHolder class holds the views for a single report row (item_student_report_subject.xml).
     */
    class SubjectViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(subject: StudentReportSubject, onClick: (StudentReportSubject) -> Unit, context: Context) {
            // Display subject name and code
            subjectName.text = "${subject.subjectName} (${subject.subjectCode})"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubjectViewHolder {
        ...
        val view = LayoutInflater.from(context)
            .inflate(R.layout.item_student_report_subject, parent, false)
